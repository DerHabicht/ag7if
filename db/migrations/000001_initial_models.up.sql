...
CREATE TABLE zone_channels (
                               ...
                               PRIMARY KEY (zone_id,
                                            channel_id));
ALTER TABLE bands ADD CONSTRAINT FKbands47296 FOREIGN KEY (service_id) REFERENCES services (id);
ALTER TABLE zones ADD CONSTRAINT FKzones534473 FOREIGN KEY (user_id) REFERENCES users (id);
ALTER TABLE channels ADD CONSTRAINT FKchannels76599 FOREIGN KEY (user_id) REFERENCES users (id);
ALTER TABLE channels ADD CONSTRAINT FKchannels870610 FOREIGN KEY (band_id) REFERENCES bands (id);
ALTER TABLE zone_channels ADD CONSTRAINT FKzone_chann239833 FOREIGN KEY (zone_id) REFERENCES zones (id);
ALTER TABLE zone_channels ADD CONSTRAINT FKzone_chann334398 FOREIGN KEY (channel_id) REFERENCES channels (id);
